%% Sense of Agency in Different Social Contexts
...
if length(Data)~=0
	ParticipantID=length(Data)+1;
else
	ParticipantID=1;
end
Data{ParticipantID}.ID=ID;
%% Resolution
...
%% Saving
Data{ParticipantID}.ID=ID;
Data{ParticipantID}.Resolution= reso;
% Training V1
Data{ParticipantID}.Training1Hits= trainingV1;
Data{ParticipantID}.Training1TrialDurations= Training1Duration;
Data{ParticipantID}.Training1DartLocations =T1DartLocs;
Data{ParticipantID}.Training1Distance=DistanceTV1;
Data{ParticipantID}.Training1Scores=TV1Scores;

% Training V2
Data{ParticipantID}.Training2Hits= trainingV2; %where participant hit
Data{ParticipantID}.Training2TrialDurations= Training2TrialDuration; %trial durations
Data{ParticipantID}.Training2PerceptionDurations=Training2PerceptionDuration; %how long did it take to decide..
Data{ParticipantID}.Training2DartLocations=T2DartLocs; %dart locations
Data{ParticipantID}.Training2Performance= T2DistanceHit;% how far was the hits
Data{ParticipantID}.Training2PerceivedPerformance=T2DistancePerception; %where the think they hit...
Data{ParticipantID}.Training2Accuracy= AccuracyTv2; %Accuracy of guess
Data{ParticipantID}.Training2HitvPerDist= DifferenceTV2; %Distance btw hit and guess...
Data{ParticipantID}.Training2Scores = TV2Scores;

%Single
Data{ParticipantID}.SinglePartHits =singlePlayer;
Data{ParticipantID}.SingleComputerHits= SingleRival;
Data{ParticipantID}.SingleParticipantHitsPresentations = ParticipantSingle;
Data{ParticipantID}.SingleComputerHitPresentations= computerCorsPer;
Data{ParticipantID}.SinglePerception = perceptionSingle;
Data{ParticipantID}.ScoresSingle = SingleScores;
Data{ParticipantID}.SingleTrialDuration =SingleTrialDuration;
Data{ParticipantID}.SingleGuessDuration =SingleGuessDuration;
Data{ParticipantID}.SingleSwaps= singleswaps;
Data{ParticipantID}.SingleExpert= SingleExpert;
Data{ParticipantID}.SingleNoob= SingleNoob;
Data{ParticipantID}.SingleRivalOrder= SingleRivalOrder;
Data{ParticipantID}.SingleParticipantDist= SingleDist;
Data{ParticipantID}.SingleRivalDist= RivalDist;
Data{ParticipantID}.Single_sDev= SPsDev;
Data{ParticipantID}.Single_mu= SPmu;
Data{ParticipantID}.SingleDartLocations= SingleDartLocs;
Data{ParticipantID}.SingleAbsDist= SingleAbsDist;


% Multi
Data{ParticipantID}.MultiParticipantHits =ParticipantMulti;
Data{ParticipantID}.MultiPerception = perceptionMulti;
Data{ParticipantID}.MultiParticipantHitPresentations=ParticipantMulti;
Data{ParticipantID}.MultiComputerHitPresentations=computerCorsPresentation;
Data{ParticipantID}.MultiTrialDuration=MultiTrialDuration;
Data{ParticipantID}.MultiGuessDuration=MultiGuessDuration;
Data{ParticipantID}.MultiScoresPartcipant = MultiScores;   %Data{5}.MultiScoresPartcipant
Data{ParticipantID}.MultiScoresExperimenter = ExperimenterScores;
Data{ParticipantID}.MultiPartDist =MultiPartDist;
Data{ParticipantID}.MultiRivalDist= MultiRivalDist;
Data{ParticipantID}.Multi_mu=  MPmu;
Data{ParticipantID}.Multi_sDev=  MPsDev;
Data{ParticipantID}.MultiExpert= MultiExpert;
Data{ParticipantID}.MultiNoob= MultiNoob;
Data{ParticipantID}.MultiRival= MultiRival; %coordinates...
Data{ParticipantID}.MultiRivalOrder= MultiRivalOrder;
Data{ParticipantID}.MultiSwaps= multiswaps;
Data{ParticipantID}.MultiDartLocations= MultiPlayerDartLocs;
